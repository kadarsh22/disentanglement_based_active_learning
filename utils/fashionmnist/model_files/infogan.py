...
class generator(nn.Module):
    ...
    def __init__(self, input_dim=62, output_dim=1, input_size=28, len_discrete_code=10, len_continuous_code=2):
...
class discriminator(nn.Module):
    ...
    def __init__(self, input_dim=1, output_dim=1, input_size=28, len_discrete_code=10, len_continuous_code=2):
